...
#define dbg_print(s) HAL_UART_Transmit(&huart1, s, strlen(s), 0xFFFF)
#endif
//------------------------------------------------

uint8_t NRF_TX_ADDR[ADR_WIDTH] = { 0xb5, 0xb5, 0xa1 }; //HOST ADDRESS 
uint8_t NRF_RX_ADDR[ADR_WIDTH] = { 0xb7, 0xb5, 0xa1 }; //SELF ADDRESS 

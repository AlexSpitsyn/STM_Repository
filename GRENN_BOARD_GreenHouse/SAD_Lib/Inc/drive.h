...
#define DRV_OPEN()			DRV_DIR=1;  HAL_GPIO_WritePin(M_DRV2_GPIO_Port,M_DRV2_Pin,GPIO_PIN_RESET);HAL_Delay(1000); HAL_GPIO_WritePin(M_DRV1_GPIO_Port,M_DRV1_Pin,GPIO_PIN_SET); drv_m1.run_f=1;SysCnt.drv_move=0; 
#define DRV_CLOSE()			DRV_DIR=0;  HAL_GPIO_WritePin(M_DRV1_GPIO_Port,M_DRV1_Pin,GPIO_PIN_RESET); HAL_Delay(1000); HAL_GPIO_WritePin(M_DRV2_GPIO_Port,M_DRV2_Pin,GPIO_PIN_SET); drv_m1.run_f=1;	SysCnt.drv_move=0;

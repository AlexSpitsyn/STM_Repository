...
#define OPTOCUP_B_Pin GPIO_PIN_4
#define OPTOCUP_B_GPIO_Port GPIOB
#define OPTOCUP_B_EXTI_IRQn EXTI4_IRQn
#define OPTOCUP_A_Pin GPIO_PIN_5
#define OPTOCUP_A_GPIO_Port GPIOB
#define OPTOCUP_A_EXTI_IRQn EXTI9_5_IRQn

...
SX1278_t SX1278 = {0};//{.POWER =0, .SF=0, .BW=0, .CR=0, .packetLength=0, .status=SLEEP, .readBytes=0, .tx_complete_f=0, .timeout_f=0};
...
uint8_t SX1278_LoRaRxPacket(void) {
	...
	if (HAL_GPIO_ReadPin(SX1278_DIO0_PORT, SX1278_DIO0_PIN)) {

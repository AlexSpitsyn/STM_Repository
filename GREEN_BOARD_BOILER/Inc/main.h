...
#define SP12_NSS2_Pin GPIO_PIN_3
#define SP12_NSS2_GPIO_Port GPIOA
...
#define EXT_IRQ_Pin GPIO_PIN_1
#define EXT_IRQ_GPIO_Port GPIOB
#define EXT_IRQ_EXTI_IRQn EXTI1_IRQn
#define EXT_CE_Pin GPIO_PIN_2
#define EXT_CE_GPIO_Port GPIOB

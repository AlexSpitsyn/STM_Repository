...
#define RELEY_BURNER_Pin GPIO_PIN_3
#define RELEY_BURNER_GPIO_Port GPIOA
...
#define XP9_8_Pin GPIO_PIN_1
#define XP9_8_GPIO_Port GPIOB
#define RELEY_PUMP_Pin GPIO_PIN_2
#define RELEY_PUMP_GPIO_Port GPIOB
